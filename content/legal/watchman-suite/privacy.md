...
This Privacy Policy explains how ESCT Holding Inc. collects, uses, stores, shares, protects, and retains information through Watchman Suite. This document is intended for publication on the public website and for display inside the application before account activation, installation, or first use.

Watchman Suite is a multi-tenant security operations suite.
...
1. Provide, operate, secure, maintain, and improve Watchman Suite.
...
Retention may vary by tenant configuration, product function, legal requirement, and record type. Deleting data from Watchman Suite may not delete copies retained by third-party providers, integrations, backups, audit logs, legal holds, or tenant-controlled exports.
...
Watchman Suite is not intended for children under 13. Tenant administrators must not knowingly authorize child-directed use unless a separate child-privacy review and written legal approval have been completed.
