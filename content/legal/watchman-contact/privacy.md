# Watchman Contact Privacy Policy

Effective Date: June 24, 2026  
Product: Watchman Contact  
Owner: ESCT Holding Inc.  
Repository: watchmanbyesct/watchman-contact  
Version: watchman-contact-privacy-v1.0

## 1. Purpose

This Privacy Policy explains how ESCT Holding Inc. collects, uses, stores, shares, protects, and retains information through Watchman Contact. This document is intended for publication on the public website and for display inside the application before account activation, installation, or first use.

Watchman Contact is a lightweight contact intake, form capture, export, and records management application.

## 2. Information We Collect

Depending on configuration and enabled features, Watchman Contact may collect or process the following categories of information:
...
2. Operational or product data, including prospect/client contact records, intake forms, notes, export files, user accounts, device metadata, support requests, and audit logs.
...
6. Payment or billing references if payment, subscription, enrollment, or invoicing features are enabled. Full payment card details should be handled by authorized payment processors and should not be stored by Watchman Contact unless explicitly approved through a secure payment architecture.

## 3. How We Use Information

ESCT Holding Inc. uses information to:

1. Provide, operate, secure, maintain, and improve Watchman Contact.
...
Retention may vary by tenant configuration, product function, legal requirement, and record type. Deleting data from Watchman Contact may not delete copies retained by third-party providers, integrations, backups, audit logs, legal holds, or tenant-controlled exports.
...
Watchman Contact is not intended for children under 13. Tenant administrators must not knowingly authorize child-directed use unless a separate child-privacy review and written legal approval have been completed.
...
1. Create a public route for this document at `/legal/watchman-contact/privacy` or `/privacy/watchman-contact`.
...
3. Store this document as `privacy.md` in `legal/watchman-contact/privacy.md` or the product repository equivalent.
4. Display the version `watchman-contact-privacy-v1.0` and effective date in the UI.
5. Require users to accept the current Privacy Policy before workspace activation, form publication, contact record creation, export, or mobile/tablet installation.
