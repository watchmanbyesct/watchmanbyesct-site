# Watchman HR Privacy Policy

Effective Date: June 24, 2026  
Product: Watchman HR  
Owner: ESCT Holding Inc.  
Repository: watchmanbyesct/Watchman-HR  
Version: watchman-hr-privacy-v1.0

## 1. Purpose

This Privacy Policy explains how ESCT Holding Inc. collects, uses, stores, shares, protects, and retains information through Watchman HR. This document is intended for publication on the public website and for display inside the application before account activation, installation, or first use.

Watchman HR is a human resources, personnel, onboarding, credentialing, and workforce management platform.

## 2. Information We Collect

Depending on configuration and enabled features, Watchman HR may collect or process the following categories of information:
...
2. Operational or product data, including employee profiles, contact information, employment records, onboarding records, credentials, licenses, certifications, documents, time-off requests, disciplinary or performance notes if enabled, emergency contacts, and audit logs.
...
6. Payment or billing references if payment, subscription, enrollment, or invoicing features are enabled. Full payment card details should be handled by authorized payment processors and should not be stored by Watchman HR unless explicitly approved through a secure payment architecture.

## 3. How We Use Information

ESCT Holding Inc. uses information to:

1. Provide, operate, secure, maintain, and improve Watchman HR.
...
Retention may vary by tenant configuration, product function, legal requirement, and record type. Deleting data from Watchman HR may not delete copies retained by third-party providers, integrations, backups, audit logs, legal holds, or tenant-controlled exports.
...
Watchman HR is not intended for children under 13. Tenant administrators must not knowingly authorize child-directed use unless a separate child-privacy review and written legal approval have been completed.
...
1. Create a public route for this document at `/legal/watchman-hr/privacy` or `/privacy/watchman-hr`.
...
3. Store this document as `privacy.md` in `legal/watchman-hr/privacy.md` or the product repository equivalent.
4. Display the version `watchman-hr-privacy-v1.0` and effective date in the UI.
5. Require users to accept the current Privacy Policy before employee portal activation, onboarding submission, document upload, credential management, or tenant administrator HR setup.
