      ...
      <section style={{ padding: '120px 24px 80px', background: 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(201,160,48,0.09), transparent 60%)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
            ...
            <Link to="/help/hr" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '12px 28px', borderRadius: 8, fontWeight: 500, fontSize: 15, color: 'rgba(255,255,255,0.85)', border: '1px solid rgba(201,160,48,0.35)', background: 'rgba(201,160,48,0.06)', textDecoration: 'none' }}>
              Help articles
            </Link>
          </div>
        </div>
